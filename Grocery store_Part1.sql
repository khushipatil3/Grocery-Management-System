-- Active: 1695366976062@@127.0.0.1@3306@grocerystore
-- create database
...
create table if NOT EXISTS location( Location_Id varchar(10) not null, Zipcode int not null, City varchar(20) not null, 
...
create table if not exists designation(Dsgn_Id varchar(20) not null, Designation varchar(20) not null,
...
create table if not EXISTS employees(Location_Id varchar(20) not null, 
...
("MCA04", 414876, "New York", "Marcus Avenue"),
...
create table if not EXISTS customers(Cust_ID int not null primary key, First_name varchar(20) not null,
...
create table if NOT exists Manager(E_Id int not null primary key, 
...
create table if not exists DBUsers(E_Id int not null primary key, Username varchar(20),
...
create table if NOT EXISTS Commodities( Product_No int not null primary key, 
Product_Name varchar(30) not null, Prod_Quantity int not null, Prod_Price int not null);

create table if NOT exists Suppliers(Supplier_No int NOT NULL Primary Key AUTO_INCREMENT,
...
( 6,'Linc',7687454092 ,"JTP01", "linc23@gmail.com" ,2 ,12 );
 ...
 create table if not EXISTS Categories(Category_Id varchar(20) not null,
